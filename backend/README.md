...
## Project Structure
    ...
    ├── testapprovaltasks_d_53590  # Django project configurations
...
1. Clone this repo and `cd testapprovaltasks_d_53590`
...
2. Clone this repo and `cd testapprovaltasks_d_53590`
